...
public:
	...
	void loadShaders()
	{
        ...
        mEffectsFormat.vertex( /*LoadShader("finalEffects.vert")*/ ci::app::loadAsset( "finalEffects.vert" ) )
		.fragment( /*LoadShader("finalEffects.frag")*/ ci::app::loadAsset( "finalEffects.frag" ) );
